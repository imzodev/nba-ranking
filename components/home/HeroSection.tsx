    ...
    <section className="relative bg-gradient-to-br from-[#17408B] via-[#17408B]/90 to-[#C9082A]/80 dark:from-[#0a1836] dark:via-[#17408B]/80 dark:to-[#C9082A]/70 text-white min-h-[100vh] flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-32">
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-3/5">
            <div className="inline-block bg-[#FDBB30] dark:bg-[#FDBB30]/90 px-4 py-1 rounded-md mb-6 transform -rotate-2 shadow-lg">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 leading-none">
              ...
              <span className="bg-white dark:bg-gray-800 text-[#17408B] dark:text-[#FDBB30] px-4 py-1 inline-block transform -rotate-1 shadow-xl">NBA RANKINGS</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-xl leading-relaxed text-white dark:text-gray-200">
              Create, share, and explore definitive rankings of the greatest NBA players of all time.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="/create" className="bg-[#FDBB30] hover:bg-[#FDBB30]/90 dark:bg-[#FDBB30]/90 dark:hover:bg-[#FDBB30] text-black px-8 py-4 rounded-md font-bold text-lg shadow-xl transition-all hover:-translate-y-1 flex items-center gap-2 group">
              ...
              <Link href="/rankings/25" className="bg-white/10 backdrop-blur-sm border-2 border-white dark:border-gray-300 hover:bg-white/20 dark:hover:bg-gray-300/20 text-white px-8 py-4 rounded-md font-bold text-lg transition-all hover:-translate-y-1 shadow-lg">
                VIEW RANKINGS
              </Link>
            </div>
          </div>
          <div className="md:w-2/5 relative mt-12 md:mt-0">
            <div className="relative w-72 h-72 md:w-80 md:h-80 mx-auto">
              <div className="absolute inset-0 bg-gradient-to-br from-[#17408B] to-[#C9082A] dark:from-[#0a1836] dark:to-[#C9082A]/90 rounded-full opacity-30 animate-pulse shadow-lg"></div>
              <div className="absolute inset-0 rounded-full border-4 border-[#FDBB30]/30 dark:border-[#FDBB30]/40 shadow-xl"></div>
              <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
                ...
                {playerImages.map((src, index) => (
                  ...
                  >
                    <div className="relative w-64 h-64 md:w-72 md:h-72 rounded-full overflow-hidden border-4 border-white/20 dark:border-gray-300/30 shadow-2xl">
                      <Image 
                        src={src} 
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full">
          <path fill="#ffffff" fillOpacity="1" className="dark:fill-gray-900" d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,133.3C672,139,768,181,864,181.3C960,181,1056,139,1152,122.7C1248,107,1344,117,1392,122.7L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
      </div>
    </section>
  );
